              ...
              (g.prototype.doXHR = function(a, e, f, g) {
                ...
                "function" == typeof i.overrideMimeType &&
                  ...
                  b.isFileProtocol && !b.fileAsync
                    ? 0 === i.status || (i.status >= 200 && 300 > i.status)
                      ? f(i.responseText)
                      : g(i.status, a)
                    : j
                  ...
                  if (
                    ...
                    (i =
                      "" === m[f].unit.toString() && void 0 !== l
                        ...
                        : m[f].unify()),
                      ((a && i.value > h.value) || (!a && h.value > i.value)) &&
                        (m[f] = g);
                  else {
                    if (void 0 !== k && j !== k)
        ...
        function(a, b, c) {
          b.exports = function(a, b) {
            ...
            var d,
              ...
              q = 0;
            for (h = 0; m > h; h++)
              if (((j = a.charCodeAt(h)), !((j >= 97 && 122 >= j) || 34 > j)))
                switch (j) {
                  case 40:
                    o++, (e = h);
                    continue;
                ...
                parsers: (n = {
                  ...
                  entities: {
                    ...
                    keyword: function() {
                      ...
                      return a
                        ? e.Color.fromKeyword(a) || new e.Keyword(a)
                        : void 0;
                    },
                    call: function() {
                      var a,
                    ...
                    unicodeDescriptor: function() {
                      ...
                      return (
                        ...
                        a ? new e.UnicodeDescriptor(a[0]) : void 0
                      );
                    },
                    javascript: function() {
                      var a,
                    ...
                    return (
                      ...
                      a ||
                        ...
                        o.$char("(")
                          ...
                          : o.forget()),
                      a ? new e.Element(b, a, f, c) : void 0
                    );
                  },
                  combinator: function() {
                    var a = o.currentChar();
                  ...
                  block: function() {
                    var a;
                    return o.$char("{") && (a = this.primary()) && o.$char("}")
                      ? a
                      : void 0;
                  },
                  ...
                  mediaFeature: function() {
                    ...
                    while (a);
                    return (
                      o.forget(), f.length > 0 ? new e.Expression(f) : void 0
                    );
                  },
        ...
        function(a, b, c) {
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.variable = function(a) {
              return this.rules
                ? f.prototype.variable.call(this.rules[0], a)
                : void 0;
            }),
            (g.prototype.find = function() {
              return this.rules
                ? f.prototype.find.apply(this.rules[0], arguments)
                : void 0;
            }),
            (g.prototype.rulesets = function() {
              return this.rules
                ? f.prototype.rulesets.apply(this.rules[0])
                : void 0;
            }),
          ...
          (j.prototype = new d()),
            ...
            (j.prototype.isVariableImport = function() {
              ...
              return (
                ...
                a instanceof g ? a.containsVariables() : !0
              );
            }),
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function(a) {
              function b(b, c) {
                var d, e, f;
                for (d = 0; 2 > d; d++) {
                  for (x[d] = !0, g.value(d), e = 0; c.length > e && x[d]; e++)
                    (f = c[e]),
                      f.matchCondition &&
              ...
              for (j = 0; this.arguments.length > j; j++)
                if (
                  ...
                  for (i = i.value, k = 0; i.length > k; k++)
                    t.push({ value: i[k] });
              ...
              for (
                ...
                if ((c = a.frames[j].find(this.selector, null, s)).length > 0) {
                  ...
                  for (g.reset(), q = [0, 0, 0], k = 0; w.length > k; k++)
                    q[w[k].group]++;
                  if (q[z] > 0) p = B;
            ...
            (m.prototype.eval = function(a) {
              ...
              for (f = 0; r.length > f; f++)
                if (
                  ...
                  r.splice(f--, 1);
                  for (var u = 0; i.rules.length > u; u++)
                    (l = i.rules[u]),
            ...
            (m.prototype.joinSelector = function(a, b, c) {
              ...
              function l(a, b, c) {
                ...
                var h,
                  ...
                  u,
                  v = !1;
                for (o = [], p = [[]], h = 0; c.elements.length > h; h++)
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.match = function(a) {
              var b,
                ...
                e = d.length;
              if (
                (a.CacheElements(), (b = a._elements.length), 0 === b || b > e)
              )
                return 0;
              for (c = 0; b > c; c++)
        ...
        function(a, b, c) {
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.isSingular = function() {
              return (
                1 >= this.numerator.length && 0 === this.denominator.length
              );
            }),
                  ...
                  for (
                    ...
                    (i = l[h]),
                      ...
                      i &&
                        ...
                        i.finished &&
                          !a.allowAfter &&
                          (d.elements.length > e + 1 || b.length > c + 1) &&
                          (i = null)),
                      i
                        ? i.finished &&
                          ((i.length = k.length),
        ...
        function(a, b, c) {
          ...
          f.prototype = {
            ...
            resolveVisibility: function(a, b) {
              ...
              return (
                ...
                this.isEmpty(c)
                  ? void 0
                  : (a.ensureVisibility(), a.removeVisibilityBlock(), a)
              );
            },
          ...
          (g.prototype = {
            ...
            visitComment: function(a, b) {
              return a.blocksVisibility() || a.isSilent(this._context)
                ? void 0
                : a;
            },
            visitMedia: function(a, b) {
            ...
            _mergeRules: function(a) {
              if (a) {
                for (var b, c, e, f = {}, g = 0; a.length > g; g++)
                  (c = a[g]),
                    c instanceof d.Rule &&
                      c.merge &&
