 ...
 */
      ...
      15: [
        function(require, module, exports) {
          ...
          abstractFileManager.prototype.extractUrlParts = function extractUrlParts(
            url,
            baseUrl
          ) {
      ...
      19: [
        function(require, module, exports) {
          module.exports = function(environment) {
            ...
            functionRegistry.add("data-uri", function(
              mimetypeNode,
              filePathNode
            ) {
              if (!filePathNode) {
     ...
     */
            ImportManager.prototype.push = function(
              ...
              var promise = fileManager.loadFile(
                path,
                currentFileInfo.currentDirectory,
                this.context,
                environment,
        ...
        function(require, module, exports) {
          module.exports = function(environment, fileManagers) {
            ...
            var less = {
              ...
              SourceMapOutput: (SourceMapOutput = require("./source-map-output")(
                environment
              )),
              SourceMapBuilder: (SourceMapBuilder = require("./source-map-builder")(
                SourceMapOutput,
                environment
              )),
              ParseTree: (ParseTree = require("./parse-tree")(
                SourceMapBuilder
              )),
              ImportManager: (ImportManager = require("./import-manager")(
                environment
              )),
 ...
 */
      ...
      40: [
        function(require, module, exports) {
          ...
          var FunctionImporter = (module.exports = function FunctionImporter(
            context,
            fileInfo
          ) {
        ...
        function(require, module, exports) {
          ...
          JsEvalNode.prototype.evaluateJavaScript = function(
            ...
            expression = expression.replace(/@\{([\w-]+)\}/g, function(
              ...
              return that.jsify(
                new Variable("@" + name, that.index, that.currentFileInfo).eval(
                  context
                )
              );
            });
          ...
          ProcessExtendsVisitor.prototype = {
            ...
            visitRuleset: function(rulesetNode, visitArgs) {
              ...
              var matches,
                pathIndex,
                extendIndex,
                allExtends = this.allExtendsStack[
      ...
      94: [
        function(require, module, exports) {
          ...
          function handleResolved(self, deferred) {
            asap(function() {
              var cb =
                self._81 === 1 ? deferred.onFulfilled : deferred.onRejected;
              if (cb === null) {
                if (self._81 === 1) {
